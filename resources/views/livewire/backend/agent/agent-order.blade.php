    ...
    <div class="stepper">
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane p-1 fade @if($step === 3) in show active @endif" role="tabpanel" id="stepper-step-3">
                @include('livewire.backend.agent.order.info')
                <div class="container">
                    <div class="list-inline pull-left">
                        <a href="/agentorder" class="btn bg-dark text-light" onclick="return confirm('Are you sure?');">Cancel</a>
                    </div>
            ...
            <div class="tab-pane p-1 fade @if($step === 5) in show active @endif" role="tabpanel" id="stepper-step-5">
                @if($step === 5) @include('livewire.backend.agent.order.done') @endif
                <div class="container">
                </div>
            </div>
